export const profile = {
  ...
  intro:
    'SI 환경에서 3년간 호텔업 등급평가와 관광기금융자, 두 도메인을 지속적으로 담당하며 발주 기관이 바뀌어도 흔들리지 않는 도메인 이해도를 쌓았습니다. 요청받은 기능을 구현하는 데서 그치지 않고, 그 기능이 왜 필요한지, 다음엔 어떤 요구가 이어질지를 함께 고민하며 구조를 설계해왔습니다.',
  stats: [
