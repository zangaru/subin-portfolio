export const profile = {
  name: '조수빈',
  role: '백엔드 · 풀스택 개발자',
  thesis: '급한 불을 끄는 개발자는 많습니다. 불이 나기 전에 막는 개발자는 드뭅니다.',
  stats: [
...
export const timeline = [
  {
    ...
    detail:
      '호텔업 등급평가 · 관광기금융자 지속 운영/고도화, wfk 긴급 투입, 코이카 GHBM 신규 구축(모집선발 메뉴 사용자 화면 담당) 진행 중',
    note: 'GHBM은 JSP · eGov Framework · MyBatis 기반으로 다른 프로젝트와 스택이 다름, 프로젝트 착수 시점부터 참여',
    inProgress: true,
  },
  {
    ...
    org: '하우페이',
    position: 'SI 사업본부 · 사원',
    detail: '호텔업 등급평가 · 관광기금융자 · 관광공제회 개발/유지보수',
    note: '회사 재정난으로 폐업, 진행 중이던 프로젝트와 함께 이관',
  },
];
